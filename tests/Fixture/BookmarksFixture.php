...
class BookmarksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_bookmarks_users' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created_at' => '2016-05-08 05:41:12',
            'updated_at' => '2016-05-08 05:41:12',
            'user_id' => 1
        ],
    ];
}
